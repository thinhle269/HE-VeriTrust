...
print(json.dumps({'train': list(sp.X_train.shape), 'val': list(sp.X_val.shape), 'test': list(sp.X_test.shape), 'features': sp.feature_names, 'counts': sp.class_counts()}, indent=2))
